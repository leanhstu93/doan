...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-3 gap-4">
                            <div class="p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                                ...
                                <div class="font-semibold text-lg text-primary-600"><?php echo e($group->group_code); ?></div>
                            </div>
                            <div class="p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                                <div class="text-xs text-gray-500 dark:text-gray-400 mb-1">Năm học</div>
                                <div class="font-medium text-gray-900 dark:text-white"><?php echo e($group->academicYear?->name ?? '-'); ?></div>
                            </div>
                            <div class="p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                                <div class="text-xs text-gray-500 dark:text-gray-400 mb-1">Thành viên</div>
                                <div class="font-medium text-gray-900 dark:text-white"><?php echo e($group->members->count()); ?> sinh viên</div>
                            </div>
                        </div>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $group->members; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <div class="flex items-center gap-3 p-3 rounded-lg border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                                        <div class="flex-shrink-0 w-10 h-10 rounded-full bg-primary-100 dark:bg-primary-900 text-primary-600 dark:text-primary-400 flex items-center justify-center font-bold text-sm">
                                            <?php echo e(substr($member->student->ten, 0, 1)); ?>

                                        </div>
                                        <div class="flex-1 min-w-0">
                                            <div class="font-medium text-gray-900 dark:text-white">
                                                <?php echo e($member->student->full_name); ?>

                                            </div>
                                            <div class="text-xs text-gray-500">
                                                <?php echo e($member->student->mssv); ?>

                                            </div>
                                        </div>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($member->is_leader): ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($topic): ?>
                    <div class="space-y-5">
                        ...
                        <div class="p-4 bg-primary-50 dark:bg-primary-900/20 rounded-lg border border-primary-100 dark:border-primary-800">
                            ...
                            <div class="font-semibold text-gray-900 dark:text-white"><?php echo e($topic->ten_de_tai_tv); ?></div>
                        </div>

                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($topic->ten_de_tai_ta): ?>
                            <div>
                                <div class="text-xs text-gray-500 dark:text-gray-400 mb-1">Tên đề tài (Tiếng Anh)</div>
                                <div class="text-gray-700 dark:text-gray-300 italic"><?php echo e($topic->ten_de_tai_ta); ?></div>
                            </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div class="p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                                ...
                                <div class="font-medium text-gray-900 dark:text-white"><?php echo e($topic->gvhd?->display_name ?? 'Chưa phân công'); ?></div>
                            </div>
                            <div class="p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                                ...
                                <span class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                    ...
                                    <?php echo e($statusLabels[$topic->status] ?? $topic->status); ?>

                                </span>
                            </div>
                        </div>

                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($topic->status === 'pending'): ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($topic && $topic->status === 'approved'): ?>
        <div class="fi-section rounded-xl bg-white shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10 lg:col-span-2">
            ...
            <div class="p-6">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $submissionPhases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $phase): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <div class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                            ...
                            <div class="flex items-start justify-between mb-3">
                                <div class="flex-1">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($phase['is_not_yet_open']): ?>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($phase['submission']): ?>
                                    <span class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                        'inline-flex items-center px-2 py-1 rounded-full text-xs font-medium',
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($phase['description']): ?>
                                <p class="text-xs text-gray-500 mb-3 line-clamp-2"><?php echo e($phase['description']); ?></p>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($phase['submission']): ?>
                                <div class="space-y-2 mb-3">
                                    <div class="flex items-center gap-2 text-sm">
                                        ...
                                        <span class="truncate text-gray-700 dark:text-gray-300"><?php echo e($phase['submission']->original_name); ?></span>
                                    </div>
                                    <div class="text-xs text-gray-500 dark:text-gray-400">
                                        Nộp ngày: <?php echo e($phase['submission']->created_at->format('d/m/Y H:i')); ?>

                                    </div>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($phase['submission']->note): ?>
                                        <div class="text-xs text-gray-500 dark:text-gray-400">
                                            Ghi chú: <?php echo e($phase['submission']->note); ?>
                            ...
                            <div class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($phase['is_open']): ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($phase['submission'] && in_array($phase['status'], ['pending', 'rejected'])): ?>
                                        
                                        <a href="<?php echo e(\App\Filament\Student\Resources\FileSubmissionResource::getUrl('edit', ['record' => $phase['submission']->id])); ?>" class="fi-btn fi-btn-size-sm fi-btn-color-primary w-full inline-flex items-center justify-center gap-1 px-3 py-2 text-sm font-medium rounded-lg transition-colors duration-200 bg-primary-600 text-white hover:bg-primary-500">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-4 h-4">
                                    ...
                                    <?php else: ?>
                                        ...
                                        <a href="<?php echo e(\App\Filament\Student\Resources\FileSubmissionResource::getUrl('view', ['record' => $phase['submission']->id])); ?>" class="fi-btn fi-btn-size-sm fi-btn-color-primary w-full inline-flex items-center justify-center gap-1 px-3 py-2 text-sm font-medium rounded-lg transition-colors duration-200 bg-primary-600 text-white hover:bg-primary-500">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-4 h-4">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasOpenPhase): ?>
...
<?php endif; ?>
<?php /**PATH D:\xampp\htdocs\quanly-doan\resources\views/filament/student/pages/dashboard.blade.php ENDPATH**/ ?>