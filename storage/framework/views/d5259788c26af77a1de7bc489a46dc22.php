        ...
        <main class="main">
            <section class="hero">
                ...
                <div class="panel">
                    ...
                    <div class="roles">
                        <a class="role admin" href="<?php echo e(url('/admin/login')); ?>">
                        ...
                        <a class="role student" href="<?php echo e(url('/student/login')); ?>">
                        ...
                        <a class="role lecturer" href="<?php echo e(url('/lecturer/login')); ?>">
...
<?php /**PATH D:\xampp\htdocs\quanly-doan\resources\views/home.blade.php ENDPATH**/ ?>